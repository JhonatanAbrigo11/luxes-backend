...
import { AuthController } from '../adapters/http/authController.js';
...
export function createAuthRoutes(authController: AuthController): Router {
  ...
  router.put(
    ...
    authMiddleware,
    requireRoles(['admin', 'Administrador']),
    (req, res) => authController.toggleUserStatus(req, res)
  );
  router.delete(
    '/users/:id',
    authMiddleware,
  ...
  router.post(
    ...
    authMiddleware,
    requireRoles(['admin', 'Administrador']),
    (req, res) => authController.createRole(req, res)
  );
  router.put(
    '/roles/:id',
    authMiddleware,
    requireRoles(['admin', 'Administrador']),
    (req, res) => authController.updateRole(req, res)
  );
  router.delete(
    '/roles/:id',
    authMiddleware,
    requireRoles(['admin', 'Administrador']),
    (req, res) => authController.deleteRole(req, res)
  );
  router.get(
    '/permissions',
    authMiddleware,
    requireRoles(['admin', 'Administrador']),
    (req, res) => authController.listPermissions(req, res)
  );
  ...
  router.get(
    ...
    authMiddleware,
    requireRoles(['admin', 'Administrador']),
    (req, res) => authController.listAuditLogs(req, res)
  );
